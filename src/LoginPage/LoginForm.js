      ...
      <div className="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
          <form style={{display: 'block'}} name="form" onSubmit={handleSubmit}>
            ...
            <div className="intro-x mt-8">
                <input style={{padding:"0.75em 1em"}} type="text" className="intro-x login__input input input--lg border border-gray-300 block" placeholder="Email" name="email" value={email} onChange={handleChange} />
                {submitted && !email &&
                  <div className="invalid-feedback">Email is required</div>
                }
                <input style={{padding:"0.75em 1em"}} type="password" className="intro-x login__input input input--lg border border-gray-300 block mt-4" placeholder="Password" name="password" value={password} onChange={handleChange} />
                {submitted && !password &&
            ...
            <div className="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                ...
                <Link to="/Register" className="button button--lg w-full xl:w-32 text-gray-700 border border-gray-300 mt-3 xl:mt-0">Sign up</Link>
            </div>
          </form>
          <div className="intro-x mt-10 xl:mt-24 text-gray-700 text-center xl:text-left">
              By signin up, you agree to our 
              <br/>
              <a className="text-theme-1" href="">Terms and Conditions</a> & <a className="text-theme-1" href="">Privacy Policy</a> 
          </div>
      </div>
  </div>
  )

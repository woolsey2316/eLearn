    ...
    <div className="sm:w-25 sm:intro-y sm:box sm:bg-theme-1 sm:p-5 sm:m-2 box hidden sm:block">
      ...
      <div className="border-t border-theme-3 mt-5 pt-5 text-white">
        ...
        <a href="" className="flex items-center px-3 py-2 mt-2 rounded-md truncate">
          ...
          Marked for Review, <br/> Question was NOT <br/>answered
        </a>
        <a href="" className="flex items-center px-3 py-2 mt-2 rounded-md truncate">
      ...
      <div className="border-t border-theme-3 mt-5 pt-5 text-white">
        <button style={{width:"100%"}} className="button flex items-center justify-center inline-block py-5 mb-2 bg-theme-2 text-gray-700">
          <Icon.CheckCircle className="my-auto mx-2"/>Submit Exam
        </button>
      </div>
    </div>
  )

...
function ExamInstructions() {
  return (
    <React.Fragment>
      <h2 className="font-medium underline pb-10">General Instructions:</h2>
      <h2 className="">
      ...
      <h2 className="">
        ...
        submit your examination. గడియారం సర్వర్ పై సెట్ చేయబడును. స్క్రీన్ కు పై
        భాగములో కుడి మూలలో (కార్నెర్ లో) కౌంట్ డౌన్ టైమర్ మీకు పరీక్ష పూర్తీ
        చేయడానికి అందుబాటులో ఉండే మిగితా సమయం సూచిస్తుంది. టైమర్ జీరో కు
        చేరుకున్నప్పుడు, పరీక్ష దానంతట అదే ముగుస్తుంది, ప్రత్యేకంగా సబ్మిట్ చేయ
        వళసిన అవసరం లేదు.
      </h2>
      <h2 className="">
        3. The Question Palette displayed on the right side of screen will show
        ...
        would like to look at that question again. If a question is answered and
        Marked for Review, your answer for that question will be considered in
        the evaluation. <br />
      ...
      <h2 className="">
        ...
        question palette to collapse the question palette thereby maximizing the
        question window. To view the question palette again, you can click on
        "&#60;" arrow which appears on the right side of question window. ప్రశ్న
        విండో పరిమాణం పెంచటానికి (Maximize), మీరు &#8220; &#60; &#8221; యారో పై
        క్లిక్ చేయండి, ప్రశ్న విండో పరిమాణం తగ్గించటానికి, &#8220; &#62; &#8221;
        యారో పై క్లిక్ చేయండి. <br />
        <br />
        5. You can click on Scroll Down to navigate to the bottom and Scroll Up
        to navigate to the top of the question area, without scrolling. మీరు పై
        నుండి కిందకు వెళ్ళడానికి Scroll Down యారో పై క్లిక్ చేయండి, కింద నుండి
        పైకి వెళ్ళడానికి Scroll Up యారో పై క్లిక్ చేయండి. <br />
        <br />
        <h2 className="font-medium">
          Navigating From One Question to Another Question: ఒక ప్రశ్న నుండి మరొక
          ప్రశ్నకు వెళ్ళడం (నావిగేషన్): <br />
          <br />
        </h2>
        6. To answer a question, do the following: Click on the question number
        in the Question Palette at the right of your screen to go to that
        numbered question directly. Note that using this option does NOT save
        your answer to the current question. Click on Save & Next to save your
        answer for the current question and then go to the next question. Click
        on Mark for Review & Next to save your answer for the current question,
      ...
      <h2 className="">
        ...
        d) To mark the question for review, click on the Mark for Review & Next
        button. <br />
        ...
        ప్రశ్నలకు జవాబు ఇవ్వడానికి పద్దతి: మీ జవాబు సెలెక్ట్ చేయడానికి, ఎంపికలలో
        ఒకదాని బటన్ పై క్లిక్ చేయండి. మీరు ఎంపిక చేసిన జవాబును మార్చడానికి,
        ఇంకొక ఎంపిక బటన్ పై క్లిక్ చేయండి. మీరు ఎంపిక చేసిన జవాబును
        తీసివేయడానికి, మళ్ళి ఎంపిక చేసిన బటన్ పై క్లిక్ చేయండి లేదా Clear
        Response బటన్ పై క్లిక్ చేయండి. మీ జవాబును సేవ్ చేయడానికి, మీరు Save &
        Next బటన్ పై క్లిక్ చేయాలి. ప్రశ్నను పునరాలోచన కోసం మార్క్ చేయడానికి,
        పునరాలోచన కోసం Mark for Review & Next బటన్ పై క్లిక్ చేయండి. పునరాలోచన
        కోసం మార్క్ చేసిన ప్రశ్నకు ఒక వేళ జవాబు ఎంపిక చేస్తే, ఆ జవాబు మూల్యాంకనం
        కోసం పరిగణలోనికి తీసుకోబడును.
      </h2>
      <h2 className="">
        ...
        above. ఇప్పటికే జవాబు ఇచ్చిన ప్రశ్నకు మీ జవాబును మార్చాలనుకుంటే, మొదట ఆ
        ప్రశ్నను ఎంపిక చేసి , 6(b) లో సూచించిన పద్దతిని పాటించండి.
      </h2>
      <h2 className="">
        ...
        <h2 className="font-medium">
          <br />
          Navigating through sections: ఒక సెక్షన్ నుండి మరొక సెక్షన్ కు వెళ్ళడం
          (నావిగేషన్):
          <br />
        </h2>
        10. Various section names in this question paper are displayed on the
        top bar of the screen. Questions in a section can be viewed by clicking
        on the section name. The section name you are currently viewing is
        highlighted. ఈ ప్రశ్నపత్రంలోని సెక్షన్ లు స్క్రీన్ టాప్ బార్ పై
        ప్రదర్శించబడతాయి.. సెక్షన్ పేరు పై క్లిక్ చేసి ఆ సెక్షన్ యొక్క ప్రశ్నలను
        వీక్షీంచవచ్చు. మీరు వీక్షీస్తున్న ప్రస్తుత సెక్షన్ హై లైట్ చేయబడింది.
      </h2>
      <h2 className="">
      ...
      <h2 className="">
        ...
        stipulated. మీకు కేటాయించిన సమయంలో మీ సౌలభ్యం ప్రకారం మీరు సెక్షన్ల నైన
        ప్రశ్నల నైన పరీక్ష మధ్యలో షఫుల్ చేసుకోవచ్హు.
      </h2>
      <h2 className=" pb-5">
        13. Candidate can view the corresponding section summary as part of the
        legend that appears in every section above the question palette. ప్రతి
        సెక్షన్ లో ప్రశ్న పాలెట్ పై ప్రదర్శించే లెజెండ్ ద్వారా అభ్యర్ధి సంబంధిత
        సెక్షన్ సారాంశం చూడవచ్చు.
      </h2>
    </React.Fragment>
  );
}
